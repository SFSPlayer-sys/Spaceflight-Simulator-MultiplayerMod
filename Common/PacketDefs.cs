...
namespace MultiplayerSFS.Common
{
    public enum PacketType
    {
        ...
        SendChatMessage,
        /// <summary>
        /// Sent by the server to display a toast message to players.
        /// </summary>
        ShowToastMessage,
        ...
        TimeWarpRequest,
        /// <summary>
        /// Sent by server to all players to vote on time warp request.
        /// </summary>
        TimeWarpVote,
        /// <summary>
        /// Sent by player to vote agree or reject on time warp.
        /// </summary>
